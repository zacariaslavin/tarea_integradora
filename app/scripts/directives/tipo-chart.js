...
angular.module("obrasMduytApp").directive("tipoChart", function() {
	return {
		...
		template:
			"<div class='row chart-item'><div id='tipo-chart'><div class='col-md-2'><h4>Filtrar por tipo de obra</h4></div></div><div class='col-md-2'><p></p></div><div class='col-md-10 label-slug'><h3></h3></div></div>",
		replace: true,
